...
if (typeof sheet === 'undefined') {
  parentPort.postMessage({ error: true, dom: new JSDOM('<table><tr color="red"><td style="width: 100%; max-width: 100%;">此版本中尚不存在或已删除的工作表</td></tr></table>').serialize() });
}
else if (typeof sheet['!ref'] === 'undefined') {
  parentPort.postMessage({ error: true, dom: new JSDOM(`<table><tr color="red"><td style="width: 100%; max-width: 100%;">该工作表内容为空</td></tr></table>`).serialize() });
}
else {
